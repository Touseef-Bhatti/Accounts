...
<div class="alert alert-warning">
    <strong>Note:</strong> PDF download is not available because <code>dompdf</code> is not installed. You can still view the document in the preview and print it using your browser's print function.
</div>
<?php endif; ?>
...
<div class="card shadow-sm mb-4">
    <div class="card-header py-2 small text-muted"><?= $hasDompdf ? 'PDF preview (matches downloaded file)' : 'Document Preview' ?></div>
