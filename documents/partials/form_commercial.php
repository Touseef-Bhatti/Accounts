    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-3"><label class="form-label">Date</label>
                <input type="date" name="ci[invoice_date]" class="form-control" value="<?= e(v($c,'invoice_date', date('Y-m-d'))) ?>"></div>
            ...
            <div class="col-md-3"><label class="form-label">L/C Date</label>
                <input type="date" name="ci[lc_date]" class="form-control" value="<?= e(v($c,'lc_date')) ?>"></div>
            <div class="col-md-6"><label class="form-label">Exporter</label>
                <input name="ci[exporter_name]" class="form-control" value="<?= e(v($c,'exporter_name')) ?>"></div>
            ...
            <div class="col-12"><label class="form-label">Exporter Address</label>
                <textarea name="ci[exporter_address]" class="form-control" rows="2"><?= e(v($c,'exporter_address')) ?></textarea></div>
            <div class="col-md-6"><label class="form-label">Buyer</label>
                <input name="ci[buyer_name]" class="form-control" value="<?= e(v($c,'buyer_name')) ?>" required></div>
            <div class="col-md-6"><label class="form-label">Consignee</label>
                <input name="ci[consignee_name]" class="form-control" value="<?= e(v($c,'consignee_name')) ?>"></div>
            <div class="col-md-6"><label class="form-label">Buyer Address</label>
                <textarea name="ci[buyer_address]" class="form-control" rows="2"><?= e(v($c,'buyer_address')) ?></textarea></div>
            <div class="col-md-6"><label class="form-label">Consignee Address</label>
                <textarea name="ci[consignee_address]" class="form-control" rows="2"><?= e(v($c,'consignee_address')) ?></textarea></div>
            <div class="col-12"><label class="form-label">Notify Party</label>
                <textarea name="ci[notify_party]" class="form-control" rows="2"><?= e(v($c,'notify_party')) ?></textarea></div>
            <div class="col-md-3"><label class="form-label">Origin</label>
                <input name="ci[country_origin]" class="form-control" value="<?= e(v($c,'country_origin','Pakistan')) ?>"></div>
            <div class="col-md-3"><label class="form-label">Destination</label>
                <input name="ci[country_destination]" class="form-control" value="<?= e(v($c,'country_destination')) ?>"></div>
            <div class="col-md-3"><label class="form-label">Port Loading</label>
                <input name="ci[port_loading]" class="form-control" value="<?= e(v($c,'port_loading')) ?>"></div>
            <div class="col-md-3"><label class="form-label">Port Discharge</label>
                <input name="ci[port_discharge]" class="form-control" value="<?= e(v($c,'port_discharge')) ?>"></div>
            <div class="col-md-4"><label class="form-label">Vessel / Flight</label>
                <input name="ci[vessel_flight]" class="form-control" value="<?= e(v($c,'vessel_flight')) ?>"></div>
            <div class="col-md-4"><label class="form-label">B/L or AWB No.</label>
                <input name="ci[bl_awb_no]" class="form-control" value="<?= e(v($c,'bl_awb_no')) ?>"></div>
            <div class="col-md-4"><label class="form-label">Incoterms</label>
                <input name="ci[incoterms]" class="form-control" value="<?= e(v($c,'incoterms','FOB')) ?>"></div>
            <div class="col-12"><label class="form-label">Payment Terms</label>
                <input name="ci[payment_terms]" class="form-control" value="<?= e(v($c,'payment_terms')) ?>"></div>
            <div class="col-12"><label class="form-label">Shipping Marks</label>
                <textarea name="ci[shipping_marks]" class="form-control" rows="2"><?= e(v($c,'shipping_marks')) ?></textarea></div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-sm line-items" data-type="commercial">
                ...
                <tr>
                    <td><input name="lines_commercial[][description]" class="form-control form-control-sm" value="<?= e($row['description'] ?? '') ?>"></td>
                    <td><input name="lines_commercial[][hs_code]" class="form-control form-control-sm" value="<?= e($row['hs_code'] ?? '') ?>"></td>
                    ...
                    <td><input name="lines_commercial[][unit]" class="form-control form-control-sm" value="<?= e($row['unit'] ?? 'MT') ?>"></td>
